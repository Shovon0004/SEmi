...
const FAQ = () => {
  ...
  return (
    <section id="faq" ref={faqRef} className="py-20 bg-gradient-to-b from-white to-hackathon-lightblue/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 transform transition-all duration-700 hover:scale-105">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-hackathon-blue relative inline-block">
        ...
        <div className="max-w-3xl mx-auto">
            ...
            {faqItems.map((item, index) => (
              <AccordionItem 
                ...
                className={cn(
                  ...
                  "bg-white shadow-sm hover:shadow-md transition-all duration-500 opacity-0 translate-y-10",
                  "hover:border-hackathon-pink/50"
                )}
              >
                <AccordionTrigger className="px-6 py-4 text-left font-medium text-hackathon-blue hover:text-hackathon-pink transition-colors duration-300">
                  {item.question}
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4 text-slate-600 animate-slide-down">
          ...
          <div className="mt-10 text-center">
            ...
            <button className="bg-hackathon-blue text-white px-6 py-3 rounded-full hover:bg-hackathon-pink transition-colors duration-300 transform hover:scale-105 hover:shadow-lg">
              Contact Us
            </button>
          </div>
        </div>
