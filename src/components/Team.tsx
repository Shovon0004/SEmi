...
const Team = () => {
          ...
          <div className="p-6 flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-2/3">
              <div className="flex justify-between items-start">
                ...
                <button 
                  onClick={closeModal}
                  className="text-slate-400 hover:text-slate-600 transition-colors transform hover:rotate-90 transition-transform duration-300"
                >
  ...
  return (
    <section id="team" ref={teamRef} className="py-20 bg-slate-50 opacity-0">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-800 relative inline-block">
            Meet the Team
